...
export default function BasicTabs() {
  ...
  console.log("userid", JSON.parse(Base64.decode(userid)));
  ...
  const [addharbuttondDissabled, setAddharButtonDissabled] = useState(false);
  ...
  console.log("NextUserStatus", NextUserStatus);
  ...
  const getVariables = async () => {
    ...
    if (userres) {
      setStoreAddInfo(userres[0].variables.slice(1, -1).split(','))
    }
                          ...
                          <Tabs value={values} onChange={handleChange} aria-label="basic tabs example" centered>
                            ...
                            {dataClient.otpbased === 1 ?
                              <Tab label="Verify By OTP"
                                className={dataClient.otp > 0 ? "d-none" : "d-block"}
                                //  disabled
                                {...a11yProps(
                                  2
                                )} />
...
test
                          ...
                          dataClient.pan === 1 ? <>
                            <TabPanel value={values} index={
                              (() => {
                                ...
                                if (dataClient.otpbased === 0) if (dataClient.adhaar === 0 && dataClient.adhaar_verify_with_otp === 2) return 0
                                return 1
                        ...
                        {dataClient.otpbased === 1 ? <>
                          <TabPanel value={values} index={
                            (() => {
                              if (dataClient.otpbased === 0 && dataClient.adhaar_verify_with_otp === 0) return 1
                              if (dataClient.otpbased === 1 && dataClient.pan === 1) return 1
                              return 0
                            })()
                          }
                          ...
                          >
                            <form
                              className={dataClient.otp > 0 ? "d-none" : "d-block part"}
                            >
                              <div className="row d-flex align-items-center">
...

                        {
                          NextUserStatus && NextUserStatus == 3 || dataClient.adhaar_sign === 1 ? <>
                            <TabPanel value={values} index={
                              (() => {
                                // FOR THIRD PARTY
                                if (dataClient.otpbased === 0) if (dataClient.adhaar_verify_with_otp === 1 && dataClient.pan === 1) return 2
                                if (dataClient.otpbased === 0) if (dataClient.adhaar_verify_with_otp === 2 && dataClient.pan === 1) return 1
                                if (dataClient.otpbased === 0) if (dataClient.adhaar_verify_with_otp === 2 && dataClient.pan === 2) return 0

                                if (dataClient.otpbased === 0) if (dataClient.adhaar_verify_with_otp === 1 && dataClient.pan === 0) return 1
                                if (dataClient.otpbased === 0) if (dataClient.adhaar_verify_with_otp === 2 && dataClient.pan === 0) return 0
                                if (dataClient.otpbased === 0) if (dataClient.adhaar_verify_with_otp === 0 && dataClient.pan === 1) return 1
                                ...
                                // if (dataClient.otpbased === 0 && dataClient.pan === 1) if (dataClient.adhaar_verify_with_otp === 2) return 0
                                // return 2
                                // -----------------

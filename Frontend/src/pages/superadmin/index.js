...
export default function MultiStep(props) {
  ...
  console.log("Props",props,activeComponentClassName ,inactiveComponentClassName );
  const showNav =
    ...
    show && (
      <div>
        <button
          ...
          onClick={previous}
          className='css-1ja87p4-MuiButtonBase-root-MuiButton-root ms-3'
        >
          Prev
        </button>

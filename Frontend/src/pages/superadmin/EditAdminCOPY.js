...
//         initialValues: {
//             fullname: location.state[13],
//             username: location.state[2],
...
//                                     <TextField style={{ width: 400 }} label="Company Name" type='text' color="secondary" {...getFieldProps('fullname')}
...
const EditAdmin = () => {
    ...
    const ClickBtn = async (e) => {
        // console.log("kika", values.expiry_date);
        e.preventDefault();
                    ...
                    <Form >
                        ...
                        <Row className="mb-3 ms-3">
                            ...
                            <Form.Group as={Col} controlId="formGridSelect">
                                ...
                                select
                                label="Packages"
                                value={location.state.package_id}
                                style={{ width: 400 }}
                                // {...getFieldProps('package_id')}
                                SelectProps={{
                            ...
                            >
                                ...
                                {/* <textarea className="form-control" id="exampleFormControlTextarea1" rows="1" style={{ width: '400px' }} /> */}
                        ...
                        <Row className="mb-3 ms-3">
                            ...
                            <Form.Group as={Col} controlId="formGridSelect">
                                ...
                                {/* <FormControlLabel control={<Checkbox defaultChecked={adhaar === 1} />} label="Aadhar Verify" labelPlacement="Start" onChange={(e) => setPan(e.target.checked ? "1" : "")} chacked />
                            <FormControlLabel control={<Checkbox defaultChecked={pan === 1} />} label="Pan Verify" labelPlacement="Start" onChange={(e) => setAdhar(e.target.checked ? "1" : "")} />
                            <br />
                            <FormControlLabel control={<Checkbox defaultChecked={adharSign === 1} />} label="Aadhar Sign" labelPlacement="Start" onChange={(e) => setAdharSign(e.target.checked ? "1" : "")} /> */}
                                {/* <FormControlLabel  
                             
                             label="E-Stamp" labelPlacement="Start" /> */}
                                ...
                                <>
                                    ...
                                    <div className='ms-auto d-flex'>
                                        ...
                                        {/* <FormControlLabel value="top" control={<Checkbox />} label="100" labelPlacement="Start" />
                                        <br />
                                        <FormControlLabel value="top" control={<Checkbox />} label="200" labelPlacement="Start" />
                                        <br />
                                        <FormControlLabel value="top" control={<Checkbox />} label="500" labelPlacement="Start" />
                                        <br />
                                        <FormControlLabel value="top" control={<Checkbox />} label="1000" labelPlacement="Start" /> */}
                                    </div>
                                </>

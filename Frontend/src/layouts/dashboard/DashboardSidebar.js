...
export default function DashboardSidebar({ isOpenSidebar, onCloseSidebar }) {
  ...
  //   if (response) {
  //     // console.log("respo", response[0].company_logo);
  //     setLogo(response[0].company_logo);
  //     // setRefresh(!refresh)
  //   }
  // }
  ...
  useEffect(() => {
    ...
    (document.getElementById("title").innerText = pathname.split('/')[2].toUpperCase());
    if (isOpenSidebar) {
      onCloseSidebar();
    }
  ...
  const renderContent = (
   ...
   <NavLink  to={'/admin/dashboard'}>
        ...
        {/* <img src={`/companylogo/e_sign-${logo}`} alt="profile"  className='d-flex justify-content-center' /> */}
      </Box>
